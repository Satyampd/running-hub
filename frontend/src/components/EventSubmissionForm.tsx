...
//         {/* Event Title */}
//         <div>
//           <label className="block text-sm font-medium">Event Title <span className="text-red-500">*</span></label>
//           <input
//             type="text"
//             value={formData.title}
//             onChange={(e) => setFormData({ ...formData, title: e.target.value })}
//             className="w-full px-4 py-3 rounded-lg border bg-white/50 dark:bg-gray-900/50"
...
//         {/* Event Date */}
//         <div>
//           <label className="block text-sm font-medium">Event Date <span className="text-red-500">*</span></label>
//           <input
//             type="date"
//             value={formData.date}
...
//         {/* Location */}
//         <div>
//           <label className="block text-sm font-medium">Location (City) <span className="text-red-500">*</span></label>
//           <select
...
//               className="mt-2 w-full px-4 py-3 rounded-lg border bg-white/50 dark:bg-gray-900/50"
//             />
//           )}
//         </div>
...
//         {/* Categories */}
//         <div>
//           <label className="block text-sm font-medium mb-2">Event Categories</label>
...
//               className="flex-grow px-4 py-2 border rounded-lg bg-white/50 dark:bg-gray-900/50"
//               placeholder="Add custom category"
//             />
//             <button type="button" onClick={handleAddOtherCategory} className="px-4 py-2 rounded bg-primary-500 text-white">
//               Add
//             </button>
//           </div>
...
//                 <li key={idx} className="bg-primary-100 dark:bg-primary-800 px-3 py-1 rounded-full flex items-center gap-1">
//                   {cat}
...
//         {/* URL */}
//         <div>
//           <label className="block text-sm font-medium">Registration URL <span className="text-red-500">*</span></label>
//           <input
//             type="url"
//             value={formData.url}
...
//         {/* Images + Hero Selection */}
//         <div>
//           <label className="block text-sm font-medium">Event Images (up to 3)</label>
//           <input
//             type="file"
//             accept="image/*"
//             multiple
...
//               <div key={idx} className="border rounded-lg p-2 bg-gray-100 dark:bg-gray-800">
//                 <img src={URL.createObjectURL(img)} className="h-32 object-cover w-full rounded" alt={`Upload ${idx}`} />
//                 <button
//                   type="button"
//                   onClick={() => setHeroImageIndex(idx)}
//                   className={`mt-2 w-full text-sm py-1 rounded ${
//                     heroImageIndex === idx ? 'bg-primary-600 text-white' : 'bg-gray-200'
//                   }`}
//                 >
//                   {heroImageIndex === idx ? 'Hero Image Selected' : 'Set as Display Image'}
//                 </button>
//               </div>
//             ))}
//           </div>
...
//         {/* Registration Closes */}
//         <div>
//           <label className="block text-sm font-medium">Registration Closes</label>
//           <input
//             type="date"
